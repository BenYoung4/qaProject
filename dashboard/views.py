...
def dashboard(request):
    if request.user.is_customer:
        tickets = Ticket.objects.filter(customer=request.user, is_resolved=False).count
        ...
        return render(request, 'dashboard/helpdesk_dashboard.html', context)
